...
function renderDayRow(dayId, dayInfo) {
    ...
    let lessons = scheduleData.lessons.filter(l => (currentWeek === 'ALL' || l.week === currentWeek) && l.day === dayId);
    lessons = lessons.filter(shouldShowLesson);
    ...
    lessons.forEach((lesson, idx) => {
        ...
        const weekBadge = currentWeek === 'ALL'
